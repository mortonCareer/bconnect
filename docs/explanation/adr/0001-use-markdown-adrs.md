...
### 옵션 1: Markdown ADR (`docs/explanation/adr/`)
...
### 옵션 3: PR description / commit message에만 기록
...
- 검색 / 인덱싱 거의 불가능. 현재 상태가 이렇고, 그래서 이 ADR이 필요해진 것.

## 결정사항

옵션 1 (Markdown ADR) 채택.
...
- 중립적 결과:
  - 옛 결정의 백필이 일회성 비용. 이번 PR에서 굵직한 3개 백필: ADR-0002, 0003, 0004. 이후는 작성 시점에만.
...
- [#288](https://github.com/mortonCareer/bconnect/issues/288)
