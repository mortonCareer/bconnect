...
| 디자인       | Figma                                                                                                           |
| 코드/이슈    | GitHub                                                                                                          |
| API 문서     | OpenAPI 스펙: `packages/api-client/src/spec/` (도메인별 분리, 진입점 `openapi.yaml`) + VSCode 42Crunch 익스텐션 |
| 인프라       | AWS, Vercel, Railway                                                                                            |
| 커뮤니케이션 | Slack, 카카오톡, 각 도구 내 댓글                                                                                |
...
프로젝트 루트의 [CLAUDE.md](../CLAUDE.md)에서 다음 정보를 확인할 수 있습니다:
