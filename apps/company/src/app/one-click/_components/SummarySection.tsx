...
import type { CheckItemId } from '@bconnect/business/types'
import { fetchCheckItemById } from '@bconnect/business/fetch-business'
  ...
  return (
    <div className="rounded-xl border border-gray-300 bg-white">
      {CATEGORY_GROUPS.map((group) => (
        <div key={group.id}>
          <div className="border-b border-gray-300 bg-gray-100 px-6 py-2 first:rounded-t-xl">
            <span className="text-sb-14 text-gray-700">{group.label}</span>
          </div>
          <div className="px-6">
