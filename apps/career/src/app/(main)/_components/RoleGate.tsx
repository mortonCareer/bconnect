...
/**
 * 역할 가드 — CAREER 없이 career 앱에 들어오면 프로필 생성으로 돌려보낸다.
 *
 * 가입 직후 역할은 GUEST 하나뿐이고, 프로필을 만들어야 CAREER 를 얻는다. register 는
 * 성공했는데 프로필 생성 전에 이탈한 사용자가 이 상태로 남으므로, 앱 진입 시점에 다시
 * 그 단계로 잇는다. 비로그인은 대상이 아니다 — 게스트 화면은 그대로 보여준다.
 */
