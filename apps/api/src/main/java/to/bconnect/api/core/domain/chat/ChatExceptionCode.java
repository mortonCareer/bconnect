...
public enum ChatExceptionCode implements ExceptionCode {
    ...
    INVALID_PARTICIPANT ("CH004", HttpStatus.BAD_REQUEST, "유효하지 않은 참가자 입니다.", LogLevel.WARN),
    INVALID_ATTACHMENT ("CH005", HttpStatus.BAD_REQUEST, "메시지 타입과 첨부가 일치하지 않습니다.", LogLevel.INFO);
