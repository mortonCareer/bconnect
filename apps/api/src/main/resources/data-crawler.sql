...
-- 원클릭 크롤링 (200 ~ 299) : data.sql 샘플건설 / brn 2001234567 기준
INSERT INTO kiscon_registration (ncr_gs_seq, biz_reg_no, company_name, representative, trade_name, trade_reg_no, address, region, region_detail, reg_date, announce_date, flag, phone) VALUES
(200, '2001234567', '샘플건설', '김샘플', '실내건축공사업', '서울-실내-200', '서울 강남구 테헤란로 100', '서울', '강남구', 20200101, 20200110, 'Y', '025550200'),
(201, '2001234567', '샘플건설', '김샘플', '철근콘크리트공사업', '서울-철콘-201', '서울 강남구 테헤란로 100', '서울', '강남구', 20210301, 20210310, 'Y', '025550200');

INSERT INTO kiscon_admin_penalty (ncr_gs_seq, biz_reg_no, company_name, representative, trade_name, trade_reg_no, address, region, region_detail, penalty_type, violation_content, violation_detail, penalty_ground, fine_amount, penalty_amount, stop_start_date, stop_end_date, cancel_date, correction, penalty_date, announce_date, flag, phone, has_injunction) VALUES
(210, '2001234567', '샘플건설', '김샘플', '실내건축공사업', '서울-실내-200', '서울 강남구 테헤란로 100', '서울', '강남구', '영업정지', '건설업 등록기준 미달', '자본금 미달', '건설산업기본법 제83조', 0, 0, '20250101', '20250331', NULL, NULL, 20241220, 20241228, 'Y', '025550200', 'N');

INSERT INTO kiscon_arrears (id, company_name, address, representative, penalty_history, arrears_amount, publication_period) VALUES
(200, '체불건설', '서울 서초구 서초대로 200', '박체불', '2회', '120,000,000', '2026-01-01 ~ 2026-12-31');

INSERT INTO kiscon_subcon_limits (id, violation_type, company_name, corp_no, biz_reg_no, representative, restriction_start, restriction_end, category, announcement_date) VALUES
(200, '하도급대금 미지급', '체불건설', '1101110000200', '2009876543', '박체불', '20260101', '20261231', '건축', '20251215');
...
INSERT INTO feia_fire_licenses (id, company_name, ceo_name, address, license_name, license_div) VALUES
(200, '샘플건설', '김샘플', '서울 강남구 테헤란로 100', NULL, '일반');

INSERT INTO cwma_retirement_fund (id, project_name, total_amount, start_date, end_date, company_name, normalized_company_name, client_org, address) VALUES
(200, '샘플 프로젝트 신축공사', 1500000000, DATE '2026-01-01', DATE '2026-12-31', '샘플건설', '샘플건설', '서울특별시', '서울 강남구 테헤란로 100');
