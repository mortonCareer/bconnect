...
class NotificationResponseTest {
    ...
    void renders_senderNameAndLowercaseReferenceType() {
        var response = NotificationResponse.of(
                notification(9L), "{sender}님이 메시지를 보냈습니다",
                NotificationReferenceType.CHAT_ROOM, member("홍길동"), "https://cdn.test/profile.jpg");
    ...
    void renders_reflectsRenamedSender() {
        ...
        var before = NotificationResponse.of(n, "{sender}님", NotificationReferenceType.CHAT_ROOM, member("옛이름"), null);
        var after = NotificationResponse.of(n, "{sender}님", NotificationReferenceType.CHAT_ROOM, member("새이름"), null);
    ...
    void renders_systemNotificationWithoutSender() {
        var response = NotificationResponse.of(
                notification(null), "{sender}공지", NotificationReferenceType.CHAT_ROOM, null, null);
