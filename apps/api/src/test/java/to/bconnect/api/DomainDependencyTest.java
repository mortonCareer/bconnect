...
public class DomainDependencyTest {
    ...
    @ArchTest ArchRule companyDomainRule = domainRule("company", "project", "task");
    ...
    @ArchTest ArchRule memberDomainRule = domainRule("member", "retention", "task");
    ...
    @ArchTest ArchRule projectDomainRule = domainRule("project", "company", "drive", "task");
