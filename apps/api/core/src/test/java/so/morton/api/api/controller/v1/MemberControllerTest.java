...
class MemberControllerTest {
    ...
    private static final Member SAMPLE_MEMBER = new Member(
            ...
            Role.WORKER, LocalDateTime.now(), LocalDateTime.now()
    );
    ...
    class CreateMember {
        ...
        void create_success() throws Exception {
            ...
            RegisterMemberRequest request = new RegisterMemberRequest(
                    "signup-token", "testuser", "홍길동", "01012345678", "pic.jpg", Role.WORKER
            );
    ...
    class GetMyInfo {
        ...
        @Test
        @DisplayName("인증 없이 내 정보를 조회하면 401/403을 반환한다")
    ...
    class DeleteMyInfo {
        ...
        @Test
        @DisplayName("인증 없이 회원 탈퇴하면 401/403을 반환한다")
