...
| C005 | NOT_FOUND | 404 | INFO | 요청 경로를 찾을 수 없습니다. |
...
| A004 | OTP_REVOKED | 400 | INFO | 인증번호가 만료되었습니다. |
| A005 | OTP_MAX_ATTEMPTS | 400 | INFO | 인증 시도 횟수를 초과했습니다. |
| A006 | INVALID_REFRESH_TOKEN | 401 | WARN | 유효하지 않은 리프레시 토큰입니다. |
| A007 | INVALID_ACCESS_TOKEN | 401 | WARN | 유효하지 않은 액세스 토큰입니다. |
| A008 | SESSION_EXPIRED | 401 | INFO | 세션이 만료되었습니다. |
...
| CH002 | NOT_PARTICIPANT | 403 | WARN | 채팅방 참여자가 아닙니다. |
