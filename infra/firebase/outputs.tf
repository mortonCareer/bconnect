output "project_id" {
  ...
  value       = google_firebase_project.morton.project
}
...
output "web_configs" {
  description = "Firebase 웹 앱 SDK config (career/plan/dongsan 각각)"
  value = {
    ...
    key => {
      ...
      project_id          = google_firebase_project.morton.project
